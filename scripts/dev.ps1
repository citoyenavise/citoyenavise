...
# Lance Backend et Frontend dans deux terminaux séparés

Write-Host ">> Demarrage Citoyen Avise (Environnement de developpement)" -ForegroundColor Cyan
...
Write-Host ""
Write-Host "============================================================" -ForegroundColor Cyan
Write-Host "[OK] Services disponibles:" -ForegroundColor Green
Write-Host ""
...
Write-Host "   4. Verifier a: http://localhost:5173/fr/verify?token=..." -ForegroundColor Cyan
Write-Host ""
