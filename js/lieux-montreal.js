...
const LIEUX_MTL = [
  ...
  {
    id: 'spvm-qg',
    nom: 'SPVM — Direction générale',
    cat: 'gouvernement', sousCat: 'Municipal',
    adresse: '1441 rue Saint-Urbain',
    lat: 45.5085, lng: -73.5596,
  },
  {
    id: 'spvm-pdq20',
    nom: 'SPVM — PDQ 20 (Rosemont)',
    cat: 'gouvernement', sousCat: 'Municipal',
    adresse: '940 av. Saint-Joseph E',
    lat: 45.5311, lng: -73.5748,
  },
  {
    id: 'spvm-pdq21',
    nom: 'SPVM — PDQ 21 (Outremont)',
    cat: 'gouvernement', sousCat: 'Municipal',
    adresse: '1475 rue De Castelnau O',
    lat: 45.5297, lng: -73.6126,
  },
  {
    id: 'spvm-pdq38',
    nom: 'SPVM — PDQ 38 (Plateau)',
    cat: 'gouvernement', sousCat: 'Municipal',
  ...
  {
    id: 'spvm-pdq26',
    nom: 'SPVM — PDQ 26 (Rosemont-Est)',
    cat: 'gouvernement', sousCat: 'Municipal',
    adresse: '3900 boul. Rosemont',
    lat: 45.5442, lng: -73.5838,
  },
  {
    id: 'spvm-pdq48',
    nom: 'SPVM — PDQ 48 (Centre-Ville)',
    cat: 'gouvernement', sousCat: 'Municipal',
    adresse: '1441 rue Saint-Urbain (central)',
    lat: 45.5099, lng: -73.5626,
  },
  {
    id: 'caserne-7',
