...
2026-05-26auditAudit complet + décision scénario BLecture audit 2026-05-25 (sections 1-7 intégrales). Découverte: site statique HTML invisible a la communaute, app moderne React non deployee publiquement. Decision: SCENARIO B (bascule 100% moderne). Focus FR uniquement (suppression EN + orphelines). 12 taches creees (PHASE 1 nettoyage, PHASE 2 deploiement, PHASE 3 contenu). Timeline: 4-6 semaines a 20h/semaine. Lexique informatique compile (45 termes). Compte rendu complet genere: COMPTE-RENDU-2026-05-26.mdCLAUDE.md + 12 tasklistsOK
...
2026-05-26Scénario B : Bascule 100% moderne (React/Node/PostgreSQL)Audit complet révélé: site statique + app moderne invisible = confusion. Décision: abandonnner statique, porter 30 pages editoriales en React. Aucun gauchis G.1/G.2 (449 elus, fiche complete). Timeline: 4-6 semaines a 20h/semaine. Frontend: Vercel. Phase 1 (nettoyage): 30/5-5/6. Phase 2 (deploiement): 6-19/6. Phase 3 (contenu): 20/6-3/7. Livraison: 10/7/2026.
2026-05-26Focus FR uniquement (suppression EN + pages orphelines)Asymétrie linguistique (45 FR vs 12 EN) = confusion utilisateur + dilution effort. Decision: supprimer public/en/*.html + public/pages/* (orphelines). Une fois FR stable et complete, PUIS traduire EN. Gain: ~30% travail elimine, focus maximal.
